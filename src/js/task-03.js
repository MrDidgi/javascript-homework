...
const addingToDom = function () {

  const tempNode = document.createElement(`li`);
  
  images.forEach((element)=> {
    tempNode.insertAdjacentHTML("afterbegin", `<img src=${element.url} alt='${element.alt}'>`);
  });

  galleryId.append(tempNode);
